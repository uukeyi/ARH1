...
const ContactsSection: React.FC = () => {
   ...
   const contacts = landingBlocks.elements.find((el) => {
      return el.page === "contacts";
   });
                        ...
                        <p className={description}>
                           <span
                              onClick={(e: any) => {
                                 if (isAuthSettings.isAdmin) {
                                    setIsOpen(true);
                                    setElSettings(contacts?.elements[0]);
                                 }
                              }}
                           >
                              {contacts?.elements[0].value}
                           </span>
                           ...
                           <span
                              onClick={(e: any) => {
                                 if (isAuthSettings.isAdmin) {
                                    setIsOpen(true);
                                    setElSettings(contacts?.elements[1]);
                                 }
                              }}
                           >
                              {contacts?.elements[1].value}
                           </span>
                        </p>
                           ...
                           >
                              <a
                                 onContextMenu={() => {
                                    if (isAuthSettings.isAdmin) {
                                       setIsOpen(true);
                                       setElSettings(contacts?.elements[2]);
                                    }
                                 }}
                                 href={`tel:${formatPhoneNumber(
                                    contacts?.elements[2].value.split("")
                                 )}`}
                              >
                                 <svg
                                    aria-hidden="true"
                              ...
                              <p
                                 ...
                                 onClick={(e: any) => {
                                    if (isAuthSettings.isAdmin) {
                                       setIsOpen(true);
                                       setElSettings(contacts?.elements[3]);
                                    }
                                 }}
                              >
                                 {contacts?.elements[3].value}
                              </p>
                           </div>
                           <div
                              data-aos="fade-left"
                           ...
                           >
                              <a
                                 onContextMenu={() => {
                                    if (isAuthSettings.isAdmin) {
                                       setIsOpen(true);
                                       setElSettings(contacts?.elements[4]);
                                    }
                                 }}
                                 href={`tel:${formatPhoneNumber(
                                    contacts?.elements[4].value.split("")
                                 )}`}
                              >
                                 <svg
                                    aria-hidden="true"
                              ...
                              <p
                                 ...
                                 onClick={(e: any) => {
                                    if (isAuthSettings.isAdmin) {
                                       setIsOpen(true);
                                       setElSettings(contacts?.elements[5]);
                                    }
                                 }}
                              >
                                 {contacts?.elements[5].value}
                              </p>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className={`${iconsWrapper} ${socialLinks}`}>
                        <a
                           onContextMenu={() => {
                              if (isAuthSettings.isAdmin) {
                                 setIsOpen(true);
                                 setElSettings(contacts?.elements[6]);
                              }
                           }}
                           className={icon}
                           href={contacts?.elements[6].value}
                        >
                           <svg
                              xmlns="http://www.w3.org/2000/svg"
                              x="0px"
                        ...
                        <a
                           onContextMenu={() => {
                              if (isAuthSettings.isAdmin) {
                                 setIsOpen(true);
                                 setElSettings(contacts?.elements[7]);
                              }
                           }}
                           className={icon}
                           href={contacts?.elements[7].value}
                        >
                           <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                        ...
                        <a
                           onContextMenu={() => {
                              if (isAuthSettings.isAdmin) {
                                 setIsOpen(true);
                                 setElSettings(contacts?.elements[8]);
                              }
                           }}
                           className={icon}
                           href={`mailto:${contacts?.elements[8].value}`}
                        >
                           <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="28"
